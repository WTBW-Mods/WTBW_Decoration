...
public class DecorationCommonConfig extends BaseConfig
{
  ...
  public DecorationCommonConfig(ForgeConfigSpec.Builder builder)
  {
    ...
    push("stoneGen");
    MARBLE = new StoneConfig(builder, "marble", StoneConfig.marble_provider, 20, 6, 20, 80);
    BASALT = new StoneConfig(builder, "basalt", StoneConfig.basalt_provider, 20, 6, 15, 50);
    LIMESTONE = new StoneConfig(builder, "limestone", StoneConfig.limestone_provider, 20, 6, 20, 80);
  
    WorldGenManager.registerOregen(() -> MARBLE);
    WorldGenManager.registerOregen(() -> BASALT);
    WorldGenManager.registerOregen(() -> LIMESTONE);
    
    pop();
  }
  
  public static class StoneConfig extends OreConfig
  {
    static final OreBlockProvider marble_provider = new OreBlockProvider(() -> ModBlocks.MARBLE_BLOCK, OreFeatureConfig.FillerBlockType.field_241882_a, OreBlockProvider.Validators.OVERWORLD);
    static final OreBlockProvider basalt_provider = new OreBlockProvider(() -> ModBlocks.BASALT_BLOCK, OreFeatureConfig.FillerBlockType.field_241882_a, OreBlockProvider.Validators.OVERWORLD);
    static final OreBlockProvider limestone_provider = new OreBlockProvider(() -> ModBlocks.LIMESTONE_BLOCK, OreFeatureConfig.FillerBlockType.field_241882_a, OreBlockProvider.Validators.OVERWORLD);
  
    public StoneConfig(ForgeConfigSpec.Builder builder, String name, OreBlockProvider provider, int maxVein, int perChunk, int start, int end)
    {
